...
const crisisCases: CrisisCase[] = [
    {
        ...
        fullDescription: 'In Dec 2025, residents in multiple wards of Indore reported foul-smelling water. Investigations revealed a breach in the sewage line that contaminated the main drinking water supply. Hospitals saw a sudden spike in gastroenteritis cases.',
